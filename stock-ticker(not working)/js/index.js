...
var getStocks = function () {
	...
	var wsql = "select * from yahoo.finance.quote where symbol in ('MSFT')",
...
//http://query.yahooapis.com/v1/public/yql?q=select_*_from_yahoo.finance.quotes_where_symbol_in_('aapl')&env=http%3A%2F%2Fdatatables.org%2Falltables.env&format=json&callback=?
  return $.ajax({
    url: stockYQL,
    dataType: 'json'
  });
